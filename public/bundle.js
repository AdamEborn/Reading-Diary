...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _MenuContainer = __webpack_require__(161);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _MenuItem = __webpack_require__(162);
	...
	var MenuContainer = function (_React$Component) {
		...
		function MenuContainer(props) {
			...
			return _possibleConstructorReturn(this, (MenuContainer.__proto__ || Object.getPrototypeOf(MenuContainer)).call(this, props));
		}
		...
		_createClass(MenuContainer, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_MenuItem2.default, { className: 'menu-item', displayText: 'Books I Have Read' }),
					_react2.default.createElement(_MenuItem2.default, { className: 'menu-item', displayText: 'Books I Want To Read' }),
					_react2.default.createElement(_MenuItem2.default, { className: 'menu-item', displayText: 'Search For Books' }),
					_react2.default.createElement(_MenuItem2.default, { className: 'menu-item', displayText: 'My Settings' }),
					_react2.default.createElement(_MenuItem2.default, { className: 'menu-item', displayText: 'Statistics' })
				);
			}
		}]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SearchForm = __webpack_require__(164);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _googleRequests = __webpack_require__(165);

	var _googleRequests2 = _interopRequireDefault(_googleRequests);
	...
	var SearchForm = function (_React$Component) {
		...
		_createClass(SearchForm, [{
			...
			value: function onSearch(e) {
				...
				e.preventDefault();
				_googleRequests2.default.search(this.refs.searchTerm.value).then(function (response) {
					console.log(response.items);
					_this2.setState({
						results: _this2.state.results.concat(response.items)
					});
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('input', { type: 'text', placeholder: 'search name here', ref: 'searchTerm' }),
						_react2.default.createElement('input', { type: 'submit', className: 'button', value: 'Get Book' })
					)
				);
			}
		}]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SEARCH_URL = 'https://www.googleapis.com/books/v1/volumes?q=';
	var KEY = '&key=AIzaSyDMUjZgabzIAXnIjeuxiioGW8fINUJid1k';
